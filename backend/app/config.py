...
class Config:
    ...
    # Redis configuration - temporarily disabled for development
    REDIS_URL = None  # os.getenv('REDIS_URL', 'redis://localhost:6379/0')
...
class DevelopmentConfig(Config):
    ...
    SQLALCHEMY_DATABASE_URI = os.getenv('DATABASE_URL') or \
        'postgresql://finance_user:finance_password@localhost:5432/smart_finance'
